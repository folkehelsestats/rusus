...
# Anta at dt er data.table
dt <- as.data.table(ssb)
...
library(DT)
# Vis tabellen
## kable(metadata_dt, caption = "Metadata Summary")
datatable(metadata_dt, caption = "Metadata Summary", options = list(pageLength = 10))
```
